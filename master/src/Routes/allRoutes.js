...
// User Profile
import UserProfile from "../pages/Authentication/AdminForm";
...
import AdminForm from "../pages/Authentication/AdminForm"
import ApplicantForm from "../pages/Calendar/Maincalender/ApplicantForm";
...
const authProtectedRoutes = [
  ...
  { path: "/admin/form-config", component: <AdminForm /> },
  
  // Existing routes...
  { path: "/apps-calendar", component: <ApplicantForm /> },
  { path: "/sys-admin-report", component: <ReportTable/> },


  { path: "/user-registration", component: <UserManagementSystem/> },
  ...
  { path: "/sys-admin-report1", component: <DashboardCrypto /> },
...
const publicRoutes = [
  ...
  { path: "/apply", component: <ApplicantForm /> },
